    ...
    public function build(){
        ...
        $head = function () use ($tableKeys, $item) {
            ...
            $t[] = '<th scope="col" class="p-4">
                    <div class="flex items-center"><input id="checkbox-all" aria-describedby="checkbox-1" type="checkbox" class="bg-gray-50 border-gray-300 focus:ring-3 focus:ring-cyan-200 h-4 w-4 rounded"><label for="checkbox-all" class="sr-only">checkbox</label></div></th>';
            $t[] = $item($tableKeys);
            $t[] = '<th scope="col" class="p-4">';
            $t[] = '</tr></thead>';
            return implode('',$t);
        ...
        $tableItem = function ($uid, $uname,$uemail, $urol , $pais ,$res , $ustat,$image){
            ...
            $b['avatar']='
                  ...
                  <img class="h-10 w-10 rounded-full" src="'.$image.'" alt="'.$uname.'">
                  <div class="text-sm font-normal text-gray-500">
                      <div class="text-base font-semibold text-gray-900">'.$uname.'</div>
                      <div class="text-sm font-normal text-gray-500">
            ...
            $b['userol']='<td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">'.$urol.'</td>';
            $b['pais']='<td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">
                        '.$pais.'
                        <div class="text-sm font-normal text-gray-500">
                            <span class="__cf_email__" data-cfemail="">'.$res.'</span>
                        </div>
                        </td>';
            $b['status']='<td class="p-4 whitespace-nowrap text-base font-normal text-gray-900"><div class="flex items-center"><div class="h-2.5 w-2.5 rounded-full bg-green-400 mr-2"></div>'.$ustat.'</div></td>';

            $b['editor']='<td class="p-4 whitespace-nowrap space-x-2">
<button type="button" data-modal-toggle="delete-user-modal" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 float-right text-center ml-4"><svg class="mr-2 h-5 w-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clip-rule="evenodd"></path></svg>Delete</button>
